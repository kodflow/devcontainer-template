...
| Marketplace plugins | `step_marketplace_install` | Register `kodflow` marketplace, install/update the 6 plugins (kodflow-workflow, kodflow-review, kodflow-devops, kodflow-shell, kodflow-specialists, kodflow-hooks); fail-open offline (warning, cached plugins keep working) |
