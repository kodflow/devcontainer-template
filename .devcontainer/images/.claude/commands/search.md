...
description: |
  ...
  Cross-validates sources, generates .claude/contexts/{slug}.context.md, handles conflicts.
...
allowed-tools:
  ...
  - "mcp__grepai__*"
  - "Grep(**/*)"
  - "Write(.claude/contexts/*.context.md)"
  - "Task(*)"
  - "AskUserQuestion(*)"
  - "mcp__context7__*"
...
Output: .claude/contexts/{slug}.context.md
...
slug_generation:
  ...
  output: ".claude/contexts/oauth2-jwt-auth.context.md"
```
...
**Write to:** `.claude/contexts/{slug}.context.md`
...
2. Read existing `.claude/contexts/{slug}.context.md`
...
```yaml
list_workflow:
  action: "Glob .claude/contexts/*.context.md"
  output: |
    ═══════════════════════════════════════════════
    ...
    ═══════════════════════════════════════════════
      ...
      Contexts in .claude/contexts/:
        ├─ oauth2-jwt-auth.context.md (2024-01-15)
        ├─ kubernetes-ingress.context.md (2024-01-14)
        └─ react-server-components.context.md (2024-01-13)
...
```yaml
clear_workflow:
  "--clear <slug>": "Delete .claude/contexts/{slug}.context.md"
